...
public class MediumWoodBlock{
	...
	public MediumWoodBlock(int x, int y) {
		...
		try {
			img = ImageIO.read(new File("C:\\Users\\1904731\\eclipse-workspace\\Hangry-BubsFinal\\Hangry Bubs\\src\\main\\java\\imgs\\Medium Wood Plank.png"));
		} catch (IOException e) {
	...
	*/
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = MediumWoodBlocks.class.getResource(path);
